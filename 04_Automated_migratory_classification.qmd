...
We can plot the results of the procedure in different ways thanks to `plot_segmentation` function. 
We can plot segmentation and clustering plot, segmentation and clustering map, phenology map and error index plot. This last plot plot the mean of the variables segmented of each segment, as coordinates and add error bars as the SD of these variables.

...
core.m <- c("straightness", "sinuosity", "ang_vector")
...
start_year <-  year(track$DateTime[1]) #Trip start
end_year <- year(track$DateTime[nrow(track)]) #Trip end
...
Segmentation and clustering by segclust2d package requires a trajectory class object. In addition, 
